...
df_census_raw[
    'Veterans, 2011-2015'] = df_census_raw['Veterans, 2011-2015'].str.replace(",", "")
# convert to numeric type
df_census_raw['Veterans, 2011-2015'] = pd.to_numeric(
    df_census_raw['Veterans, 2011-2015'], errors='coerce')
...
df_census_raw['Foreign born persons, percent, 2011-2015'] = df_census_raw[
    'Foreign born persons, percent, 2011-2015'].apply(clean_percentage)

# convert to numeric type
df_census_raw['Foreign born persons, percent, 2011-2015'] = pd.to_numeric(
    df_census_raw['Foreign born persons, percent, 2011-2015'], errors='coerce')
...
total_number_of_permits_2011_2015 = df_gun_data['permit'][
    (df_gun_data['month'] >= '2011-01-01') & (df_gun_data['month'] <= '2015-12-31')].sum()
